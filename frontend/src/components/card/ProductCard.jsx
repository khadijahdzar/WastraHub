...
export default function ProductCard({ product }) {
  ...
  const { id, name, price, originalPrice, region, category, images, isNew, rating } = product;
      ...
      <div className="product-card__body">
        ...
        <div className="product-card__footer">
          <div className="product-card__price">
            <span className="product-card__price-current">{formatPrice(price)}</span>
            {originalPrice && (
          ...
          {rating != null && (
            <div className="product-card__rating">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="#BB9457" aria-hidden>
